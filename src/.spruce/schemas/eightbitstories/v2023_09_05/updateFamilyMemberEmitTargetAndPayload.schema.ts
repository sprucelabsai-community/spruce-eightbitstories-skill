...
const updateFamilyMemberEmitTargetAndPayloadSchema: SpruceSchemas.Eightbitstories.v2023_09_05.UpdateFamilyMemberEmitTargetAndPayloadSchema =
    {
        ...
        fields: {
            ...
            target: {
                ...
                isRequired: true,
                options: {
                    schema: updateFamilyMemberEmitTargetSchema_v2023_09_05,
                },
            },
            /** . */
            payload: {
                ...
                isRequired: true,
                options: {
                    schema: updateFamilyMemberEmitPayloadSchema_v2023_09_05,
                },
            },
        },
    }
...
SchemaRegistry.getInstance().trackSchema(
    updateFamilyMemberEmitTargetAndPayloadSchema
)
