...
const listeners: EventFeatureListener[] = [
    {
        ...
        version: 'v2023_09_05',
        callback: require('../../listeners/eightbitstories/generate-story.v2023_09_05.listener').default,
        isGlobal: require('../../listeners/eightbitstories/generate-story.v2023_09_05.listener').isGlobal,
    },
    {
        eventName: 'get-story',
        eventNamespace: 'eightbitstories',
        version: 'v2023_09_05',
        callback: require('../../listeners/eightbitstories/get-story.v2023_09_05.listener').default,
        isGlobal: require('../../listeners/eightbitstories/get-story.v2023_09_05.listener').isGlobal,
    },
    {
        eventName: 'did-boot',
