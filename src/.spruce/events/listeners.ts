...
const listeners: EventFeatureListener[] = [
    {
        ...
        version: 'v2023_09_05',
        callback: require('../../listeners/eightbitstories/update-family-member.v2023_09_05.listener').default,
        isGlobal: require('../../listeners/eightbitstories/update-family-member.v2023_09_05.listener').isGlobal,
    },
    {
        eventName: 'did-boot',
