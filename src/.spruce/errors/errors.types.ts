...
export declare namespace SpruceErrors.Eightbitstories {
    ...
    export type UnauthorizedAccessEntity =
        SchemaEntity<SpruceErrors.Eightbitstories.UnauthorizedAccessSchema>
}
...
export declare namespace SpruceErrors.Eightbitstories {
    ...
    export type NotFoundEntity =
        SchemaEntity<SpruceErrors.Eightbitstories.NotFoundSchema>
}
...
export declare namespace SpruceErrors.Eightbitstories {
    ...
    export type MetaNotFoundEntity =
        SchemaEntity<SpruceErrors.Eightbitstories.MetaNotFoundSchema>
}
